...
function user_access_run_tests() {
    user_access_run_test(11, 'PASS', 'We create an instance of ANDISOL with no login, and make sure its valid.');
}
...
ob_start();
    ...
    echo('<div class="test-wrapper" style="display:table;margin-left:auto;margin-right:auto;text-align:left">');
        ...
        echo('<div id="user_access-tests" class="closed">');
            echo('<h2 class="header"><a href="javascript:toggle_main_state(\'user_access-tests\')">ANDISOL USER ACCESS TESTS</a></h2>');
