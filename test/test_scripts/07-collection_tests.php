...
function basic_collection_run_tests() {
    collection_run_test(93, 'TEST', 'TEST', 'asp', '', 'CoreysGoryStory');
}
...
ob_start();
    ...
    echo('<div class="test-wrapper" style="display:table;margin-left:auto;margin-right:auto;text-align:left">');
        ...
        echo('<div id="basic-storage-collection-tests" class="closed">');
            echo('<h2 class="header"><a href="javascript:toggle_main_state(\'basic-storage-collection-tests\')">BASIC STORAGE TESTS</a></h2>');
